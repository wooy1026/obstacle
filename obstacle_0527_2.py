...
class ObstacleMove:
    def __init__(self):
        ...
        self.obs_range = 20 #라이다 인식각도(180도 기준 +-)
    ...
    def move_direction(self, last, first):
        if self.direction == "right":
            ...
            Lcenter = self.center_list_left[int(floor(first / 2))]
            ...
            Rcenter = self.center_list_right[int(floor(last + (self.ranges_length - last) / 2))]
    ...
    def main(self):
        ...
        if self.manual == 1:
            ...
            if self.is_scan:
                ...
                elif not self.obstacle_exit_flag:
                    print("Auto: forward")
